...
API_TOKEN = "8083661643:AAHdDQunnnLDTtS1rFISZcXPAqNDq9HBFNA"
ALLOWED_GROUP_ID = -1002860063315
VIP_USER_ID = 6996779497
...
async def like_handler(msg: Message):
    ...
    if like_usage[region] >= 100 and user_id != VIP_USER_ID:
        await msg.reply(
    ...
    if data.get("status") == 2:
        await wait.edit_text(
            ...
            f"💬 ivsshh says max likes reached today\n\n"
